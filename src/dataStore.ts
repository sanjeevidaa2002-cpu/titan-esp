...
export const MOCK_TOURNAMENTS: Tournament[] = [
  ...
  {
    id: 't_upcoming_1',
    title: 'Victory Arena Grand Cup - Bermuda Squad',
...
export const MOCK_NOTIFICATIONS: AppNotification[] = [
  {
    id: 'n_1',
    title: 'Welcome to Victory Arena!',
...
export const DEFAULT_BRANDING = {
  websiteName: 'Victory Arena',
  websiteShortName: 'VA',
  websiteTitle: 'Victory Arena | Premier Free Fire Tournaments',
  browserTabTitle: 'Victory Arena',
  websiteTagline: 'Play. Compete. Win Real Cash.',
  footerCopyrightText: '© 2026 Victory Arena Esports. All rights reserved.',
  ...
  organizationName: 'Victory Arena',
  contactEmail: 'contact@victoryarena.com',
  supportEmail: 'support@victoryarena.com',
  ...
  splashWebsiteName: 'Victory Arena',
  splashMainTitle: 'VICTORY',
  splashSecondaryTitle: 'ARENA',
